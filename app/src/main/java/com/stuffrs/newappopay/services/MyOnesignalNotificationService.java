package com.stuffrs.newappopay.services;
...
import com.stuffrs.newappopay.model.Contact;
...
public class MyOnesignalNotificationService implements OneSignal.OSRemoteNotificationReceivedHandler {
    ...
    public void remoteNotificationReceived(Context context, OSNotificationReceivedEvent notificationReceivedEvent) {
        ...
        mutableNotification.setExtender(builder -> {
            ...
            String notificationSenderIDEndTrim = Helper.getEndTrim(notification.getTitle());
            HashMap<String, Contact> savedContacts = new Helper(context).getMyContacts();
            if (savedContacts.containsKey(notificationSenderIDEndTrim)) {
