...
import com.stuffrs.newappopay.stuffers_business.activity.FianceTab.DominaActivity;
import com.stuffrs.newappopay.stuffers_business.activity.FianceTab.UnionPayActivity;
import com.stuffrs.newappopay.stuffers_business.activity.FianceTab.WalletNewBankActivity;
import com.stuffrs.newappopay.stuffers_business.activity.contact.ContactDemoActivity;
import com.stuffrs.newappopay.stuffers_business.activity.linkbank.LinkBankAccountActivity;
import com.stuffrs.newappopay.stuffers_business.activity.lunex_card.LunexGiftActivity;
import com.stuffrs.newappopay.stuffers_business.activity.payment.GasPaymentActivity;
...
import com.stuffrs.newappopay.stuffers_business.asyntask.NotificationHelper;
import com.stuffrs.newappopay.stuffers_business.asyntask.RegisterDevice;
import com.stuffrs.newappopay.stuffers_business.communicator.AreaSelectListener;
import com.stuffrs.newappopay.stuffers_business.communicator.FinanceListener;
import com.stuffrs.newappopay.stuffers_business.communicator.InnerScanListener;
import com.stuffrs.newappopay.stuffers_business.communicator.LinkAccountListener;
import com.stuffrs.newappopay.stuffers_business.communicator.LoginRequestListener;
import com.stuffrs.newappopay.stuffers_business.communicator.MoneyTransferListener;
...
import com.stuffrs.newappopay.stuffers_business.communicator.RecyclerViewRowItemClickListener2;
import com.stuffrs.newappopay.stuffers_business.communicator.ScanRequestListener;
import com.stuffrs.newappopay.stuffers_business.communicator.ScreenTimeoutListener;
...
import com.stuffrs.newappopay.stuffers_business.communicator.UpdateProfileRequest;
...
import com.stuffrs.newappopay.stuffers_business.fragments.bottom_fragment.BottomLinkAccount;
import com.stuffrs.newappopay.stuffers_business.fragments.bottom_fragment.BottomNotCard;
import com.stuffrs.newappopay.stuffers_business.fragments.dialog.ErrorDialogFragment;
import com.stuffrs.newappopay.stuffers_business.fragments.quick_pay.WalletTransferFragment2;
...
import static com.stuffrs.newappopay.stuffers_business.utils.DataVaultManager.KEY_MOBILE;
import static com.stuffrs.newappopay.stuffers_business.utils.DataVaultManager.KEY_NAME;
import static com.stuffrs.newappopay.stuffers_business.utils.DataVaultManager.KEY_USER_DETIALS;
import static com.stuffrs.newappopay.stuffers_business.utils.DataVaultManager.KEY_USER_ID1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseMessaging.getInstance().getToken().addOnSuccessListener(new OnSuccessListener<String>() {
            ...
            public void onComplete(@NonNull Task<String> task) {
                ...
                DataVaultManager.getInstance(AppoPayApplication.getInstance()).saveFirebaseToken(task.getResult());
            }
        });
