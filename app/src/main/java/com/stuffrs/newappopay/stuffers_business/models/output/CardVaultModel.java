...
public class CardVaultModel {
    String first_name, last_name, address_1, address_2, company, city, state, postal_code, country, email, phone, fax, cell_phone, customertaxid, website, shipping_first_name, shipping_last_name, shipping_address_1, shipping_address_2, shipping_company, shipping_city, shipping_state;
    String shipping_postal_code, shipping_country, shipping_email, shipping_carrier, tracking_number, shipping_date, shipping, cc_number, cc_hash, cc_exp, cc_start_date, cc_issue_number, check_account, check_hash, check_aba, check_name, account_holder_type, account_type, sec_code, processor_id;
    String cc_bin, cc_type, created, updated, account_updated, customer_vault_id;
    ...
    public String getCc_hash() {
        return cc_hash;
    }

    public void setCc_hash(String cc_hash) {
        this.cc_hash = cc_hash;
    }
    ...
    public String getCc_issue_number() {
        return cc_issue_number;
    }

    public void setCc_issue_number(String cc_issue_number) {
        this.cc_issue_number = cc_issue_number;
    }
    ...
    public String getCheck_hash() {
        return check_hash;
    }

    public void setCheck_hash(String check_hash) {
        this.check_hash = check_hash;
    }

    public String getCheck_aba() {
        return check_aba;
    }

    public void setCheck_aba(String check_aba) {
        this.check_aba = check_aba;
    }
