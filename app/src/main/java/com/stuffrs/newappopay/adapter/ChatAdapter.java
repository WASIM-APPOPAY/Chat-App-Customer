...
import com.stuffrs.newappopay.interfaces.ContextualModeInteractor;
...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.MyViewHolder> {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setData(Chat chat) {
            Glide.with(context).load(chat.getChatImage()).apply(new RequestOptions().placeholder(R.drawable.user_chat)).into(image);
