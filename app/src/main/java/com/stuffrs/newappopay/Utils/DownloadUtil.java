package com.stuffrs.newappopay.Utils;
...
public class DownloadUtil {
    ...
    public void checkAndLoad(Context context, DownloadFileEvent downloadFileEvent) {
        ...
        if (file.exists()) {
            ...
            newIntent.setDataAndType(FileProvider.getUriForFile(context, "com.stuffrs.newappopay.fileprovider", file), Helper.getMimeType(context, Uri.fromFile(file)));
